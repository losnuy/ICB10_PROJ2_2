> 원본 출처: [https://developers.naver.com/docs/serviceapi/search/blog/blog.md](https://developers.naver.com/docs/serviceapi/search/blog/blog.md)

# 검색 > 블로그

- [블로그 검색 개요](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#블로그-검색-개요)

- [개요](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#개요)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#사전-준비-사항)

- [블로그 검색 API 레퍼런스](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#블로그-검색-api-레퍼런스)

- [블로그 검색 결과 조회](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#블로그-검색-결과-조회)
- [오류 코드](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#오류-코드)

- [검색 API 블로그 검색 구현 예제](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#검색-api-블로그-검색-구현-예제)

- [Java](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#java)
- [PHP](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#php)
- [Node.js](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#node-js)
- [Python](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#python)
- [C#](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#c)

## 블로그 검색 개요

- [개요](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#%EA%B0%9C%EC%9A%94)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
4. **애플리케이션 등록 (API이용신청)** 페이지에서 [애플리케이션 등록 세부 정보](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98-%EB%93%B1%EB%A1%9D-%EC%84%B8%EB%B6%80-%EC%A0%95%EB%B3%B4)를 입력한 다음 **등록하기**를 클릭합니다.
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/search/blog/images/search-blog-01.png)
...
![](https://developers.naver.com/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/search/blog/images/search-blog-02.png)

## 블로그 검색 API 레퍼런스

- [블로그 검색 결과 조회](https://developers.naver.com/docs/serviceapi/search/blog/blog.md#%EB%B8%94%EB%A1%9C%EA%B7%B8-%EA%B2%80%EC%83%89-%EA%B2%B0%EA%B3%BC-%EC%A1%B0%ED%9A%8C)
