> 원본 출처: [https://developers.naver.com/docs/serviceapi/search/news/news.md](https://developers.naver.com/docs/serviceapi/search/news/news.md)

# 검색 > 뉴스

- [뉴스 검색 개요](https://developers.naver.com/docs/serviceapi/search/news/news.md#뉴스-검색-개요)

- [개요](https://developers.naver.com/docs/serviceapi/search/news/news.md#개요)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/search/news/news.md#사전-준비-사항)

- [뉴스 검색 API 레퍼런스](https://developers.naver.com/docs/serviceapi/search/news/news.md#뉴스-검색-api-레퍼런스)

- [뉴스 검색 결과 조회](https://developers.naver.com/docs/serviceapi/search/news/news.md#뉴스-검색-결과-조회)
- [오류 코드](https://developers.naver.com/docs/serviceapi/search/news/news.md#오류-코드)

- [검색 API 뉴스 검색 구현 예제](https://developers.naver.com/docs/serviceapi/search/news/news.md#검색-api-뉴스-검색-구현-예제)

## 뉴스 검색 개요

- [개요](https://developers.naver.com/docs/serviceapi/search/news/news.md#%EA%B0%9C%EC%9A%94)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/search/news/news.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
뉴스 검색을 실행하기 위해 발급받은 클라이언트 아이디와 클라이언트 시크릿은 검색 API의 다른 작업을 실행할 때에도 사용할 수 있습니다. 애플리케이션을 등록하고 클라이언트 아이디와 클라이언트 시크릿을 발급받는 방법은 [블로그 검색의 사전 준비 사항](https://developers.naver.com/docs/serviceapi/search/news/../blog/blog.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)을 참고합니다.
...
- [뉴스 검색 결과 조회](https://developers.naver.com/docs/serviceapi/search/news/news.md#%EB%89%B4%EC%8A%A4-%EA%B2%80%EC%83%89-%EA%B2%B0%EA%B3%BC-%EC%A1%B0%ED%9A%8C)
...
검색 API로 뉴스 검색 결과를 조회하는 방법은 블로그 검색 결과를 조회하는 방법과 유사합니다. 뉴스 검색 결과 조회를 구현하는 방법은 [검색 API 블로그 검색 구현 예제](https://developers.naver.com/docs/serviceapi/search/news/../blog/blog.md#%EA%B2%80%EC%83%89-api-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EA%B2%80%EC%83%89-%EA%B5%AC%ED%98%84-%EC%98%88%EC%A0%9C)를 참고합니다.