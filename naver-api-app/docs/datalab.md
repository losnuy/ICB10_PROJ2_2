> 원본 출처: [https://developers.naver.com/docs/serviceapi/datalab/search/search.md](https://developers.naver.com/docs/serviceapi/datalab/search/search.md)

# 통합 검색어 트렌드

- [통합 검색어 트렌드 개요](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드-개요)

- [개요](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#개요)
- [사전 준비 사항](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#사전-준비-사항)

- [통합 검색어 트렌드 API 레퍼런스](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#통합-검색어-트렌드-api-레퍼런스)

- [네이버 통합 검색어 트렌드 조회](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#네이버-통합-검색어-트렌드-조회)
- [오류 코드](https://developers.naver.com/docs/serviceapi/datalab/search/search.md#오류-코드)
