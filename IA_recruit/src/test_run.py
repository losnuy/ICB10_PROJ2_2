"""
사람인 채용공고 수집 스크립트 실행 및 1페이지 단위 1차 검증 테스트 엔트리포인트 파일입니다.
동작 흐름:
1. 1페이지를 먼저 수집하여 정상 수집 여부를 1차 검증합니다.
2. 성공 시, 2~10페이지까지의 공고 목록을 전체 수집합니다.
3. 수집된 모든 공고 목록을 순회하며 상세페이지 정보를 수집합니다.
...
from src.scraper import SaraminScraper

def main():
    print("=== 사람인 내부감사 채용공고 수집 프로세스 시작 ===")
